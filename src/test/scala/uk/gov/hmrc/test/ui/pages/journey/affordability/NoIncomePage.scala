...
object NoIncomePage extends BasePage {

  val url: String = s"${testConfig.selfServiceTimeToPayFrontendUrl}/call-us-no-income"
  ...
  def assertContent(): Assertion = {
    if (langToggle == Language.welsh) pageContent should be(WelshContent.noIncomePageContent())
    else pageContent should be(EnglishContent.noIncomePageContent())
  }
