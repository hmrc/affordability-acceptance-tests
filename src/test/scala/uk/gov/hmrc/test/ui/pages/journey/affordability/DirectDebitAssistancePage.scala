...
object DirectDebitAssistancePage extends BasePage {

  val url: String = s"${testConfig.selfServiceTimeToPayFrontendUrl}/arrangement/direct-debit-assistance"
  ...
  def assertContent(): Assertion = {
    if (langToggle == Language.welsh) pageContent should be(WelshContent.directDebitErrorContent())
    else pageContent should be(EnglishContent.directDebitErrorContent())
  }
}
