...
object CannotAgreePlanPage extends BasePage {
  ...
  def assertContent(): Assertion = {
    if (langToggle == Language.welsh) pageContent should be(WelshContent.cannotAgreePlanContent())
    else pageContent should be(EnglishContent.cannotAgreePlanContent())
  }
