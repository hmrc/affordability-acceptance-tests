...
object CallUsAdviserPage extends BasePage {
  ...
  def assertContent(): Assertion = {
    if (langToggle == Language.welsh) pageContent should be(WelshContent.callUsAdviserContent())
    else pageContent should be(EnglishContent.callUsAdviserContent())
  }
}
