...
object WelshContent {
  ...
  def successConfirmationUpfrontContent(): String = {
    s"""Caiff eich taliad ymlaen llaw ei gymryd cyn pen 11 diwrnod gwaith. Caiff eich taliad nesaf ei gymryd ar 28ain Mawrth 2020 neu ar y diwrnod gwaith nesaf.""".stripMargin
  }
